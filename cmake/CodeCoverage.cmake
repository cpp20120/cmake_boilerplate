    ...
    if(COVERAGE_TOOL STREQUAL "llvm-cov")
        ...
        add_custom_target(coverage
            ...
            COMMAND ${LLVM_COV_PATH} export 
                -instr-profile=default.profdata 
                ${CMAKE_BINARY_DIR}/bin/${PROJECT_NAME} > ${COVERAGE_DIR}/coverage.json
        ...
        if(LCOV_PATH AND GENHTML_PATH)
            add_custom_target(coverage
                ...
                COMMAND ${LCOV_PATH} --remove ${COVERAGE_DIR}/coverage.info '/usr/*' '*/tests/*' --output-file ${COVERAGE_DIR}/filtered.info
                # Генерация HTML
